...
def _pintheon_create_container():
      ...
      try:
            ...
            command = f'docker create -d --name pintheon --dns=8.8.8.8 --network bridge -p {port}:{port}/tcp -p 9999:9999/tcp -v "{volume_path}:/home/pintheon/data" metavinci/{dapp}:{PINTHEON_VERSION}'
            print(command)
